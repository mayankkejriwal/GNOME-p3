...
def make_pre_roll_move(player, current_gameboard, allowable_moves, code):
    ...
    if code == flag_config_dict['failure_code']:
        ...
        logger.debug(
            player.player_name + ' has executed an unsuccessful preroll action, incrementing unsuccessful_tries ' +
...
def make_post_roll_move(player, current_gameboard, allowable_moves, code):
    ...
    if player.player_name == 'player_4':
        param['from_player'] = 'player_4'
        param['to_player'] = None
        param['action_params_dict'] = dict()
        param['action_params_dict']['location'] = 'Connecticut Avenue'
        param['action_params_dict']['installment_interest'] = 0.15
        param['action_params_dict']['down_payment'] = 10
        param['action_params_dict']['num_rounds'] = 3

        current_gameboard['mortgage_buy_property'] = dict()
        current_gameboard['mortgage_buy_property']['down_payment'] = param['action_params_dict']['down_payment']
        current_gameboard['mortgage_buy_property']['num_rounds'] = param['action_params_dict']['num_rounds']
        current_gameboard['mortgage_buy_property']['installment_interest'] = param['action_params_dict'][
            'installment_interest']

        param['current_gameboard'] = 'current_gameboard'
        # print(param)
        return ("post_roll_arbitrary_action", param)
    # --------------------------------------------------------------------
    # param = dict()
    # if player.player_name == 'player_3':
    #     param['from_player'] = 'player_3'
    #     param['to_player'] = None
    #     param['action_params_dict'] = dict()
    #     param['action_params_dict']['installment_interest'] = 0.15
    #     param['action_params_dict']['down_payment'] = 10
    #     param['action_params_dict']['num_rounds'] = 3
    #     param['action_params_dict']['location'] = 'Electric Company'
    #
    #     current_gameboard['mortgage_buy_property'] = dict()
    #     current_gameboard['mortgage_buy_property']['down_payment'] = param['action_params_dict']['down_payment']
    #     current_gameboard['mortgage_buy_property']['num_rounds'] = param['action_params_dict']['num_rounds']
    ...
    #     param['to_player'] = None
    #     param['action_params_dict'] = dict()
    #     param['action_params_dict']['location'] = 'Pennsylvania Railroad'
    #     param['action_params_dict']['installment_interest'] = 0.3
    #     param['action_params_dict']['down_payment'] = 30
    #     param['action_params_dict']['num_rounds'] = 3
    #
    #     current_gameboard['mortgage_buy_property'] = dict()
    #     current_gameboard['mortgage_buy_property']['down_payment'] = param['action_params_dict']['down_payment']
    #     current_gameboard['mortgage_buy_property']['num_rounds'] = param['action_params_dict']['num_rounds']
    #     current_gameboard['mortgage_buy_property']['installment_interest'] = param['action_params_dict']['installment_interest']
    #     param['current_gameboard'] = 'current_gameboard'
    #
    #     return ("post_roll_arbitrary_action", param)
